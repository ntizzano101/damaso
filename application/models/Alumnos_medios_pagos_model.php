...
class Alumnos_medios_pagos_model extends CI_Model {
	...
	public function cc_pago_iva($id){
				$sql="select cc_pago.*,categoria_iva.descripcion 
				from cc_pago LEFT join categoria_iva on cc_pago.codigo_iva=categoria_iva.codigo where cc_pago.id=?";
