        ...
        public function verificar_anulado($id){
            ...
            */
            ...
            if(count($query)==0)
                 ...
                 $this->recibo=$query[0];
				 $tc=$this->recibo->tipo_comp;
				 $nro=$this->recibo->comprobante;	
                 if(empty($query[1])){
                     $error=array();
                     $this->nc = $this->recibo;
                     $this->nc->id='';
                     //$this->nc->fecha=date('Y-m-d'); ojo por hoy
					 ...
					 $this->nc->asoc_tipo=$tc;
					 $this->nc->asoc_nro=$nro;
					 $this->nc->asoc_puerto=3;  //ojo jarcodeado
